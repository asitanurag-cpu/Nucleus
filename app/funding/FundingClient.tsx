...
import { SectorTag as SectorTagType, StageTag as StageTagType, FundingRound } from "@/lib/types";
...
export default function FundingClient({ fundingRounds }: Props) {
  ...
  }, [fundingRounds, selectedSectors, selectedStages, selectedCountry]);
