...
import { SectorTag as SectorTagType, StageTag as StageTagType, VCFirm } from "@/lib/types";
...
function LandscapeContent({ vcFirms }: Props) {
  ...
  }, [vcFirms, search, selectedStages, selectedSectors, selectedCountry]);
...
export default function LandscapeClient({ vcFirms }: Props) {
  return (
    <Suspense>
      <LandscapeContent vcFirms={vcFirms} />
    </Suspense>
  );
}
