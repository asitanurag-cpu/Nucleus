...
import type { TTOInstitution, IntelSignal } from "@/lib/types/signals";
...
export default function TTOClient({ ttoInstitutions, intelSignals }: Props) {
