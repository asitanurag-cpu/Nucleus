...
import type { AgriSignalType, IntelSignal, WatchlistEntry } from "@/lib/types/signals";
...
export default function AgriSignalsClient({ signals, watchlist }: Props) {
  ...
  const agriSignals = useMemo(
    ...
    [signals, selectedTypes, minScore]
  );
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-10 lg:px-6">
      ...
      {/* Watchlist */}
      <WeeklyWatchlistPanel vertical="agrifood" entries={watchlist} allSignals={signals} />
